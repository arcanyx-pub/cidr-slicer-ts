...
describe("Ipv4Address", () => {
    ...
    describe("Ipv4Address.toNumber()", () => {
        ...
        // Low addresses (high bit clear) were already correct.
        testStr("0.0.0.0", 0);
        testStr("0.0.0.5", 5);

        // High bit set: these regressed under the old `(x + MAX_UINT32) % MAX_UINT32`,
        // which returned a value one too small for any address >= 128.0.0.0.
