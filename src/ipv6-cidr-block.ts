...
export function ipv6CidrBlockFromString(
    block: string,
): CidrBlock<Ipv6Address, Ipv6CidrBlockSlices> {
...
function createSlices(
    ...
    return {
        ...
        get(i) {
            ...
            const sliceAddrVal = block.address.toBigInt() | suffixAddrVal;
