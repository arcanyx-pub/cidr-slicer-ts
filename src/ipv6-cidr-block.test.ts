...
describe("Ipv6CidrBlock", () => {
    ...
    test("parses and slices '1:20:3000:beef::/64' into one /64 block", () => {
        ...
        expect(slices.get(0n).toCanonicalString()).toBe("1:20:3000:beef::/64");
    });
    ...
    test("parses and slices '1:2:3:400::/56' into /64 blocks", () => {
        ...
        expect(slices.get(0n).toCanonicalString()).toBe("1:2:3:400::/64");
        expect(slices.get(1n).toCanonicalString()).toBe("1:2:3:401::/64");
        expect(slices.get(255n).toCanonicalString()).toBe("1:2:3:4ff::/64");
    });
    ...
    test("parses and slices '0:2:3::/48' into /56 blocks", () => {
        ...
        expect(slices.get(0n).toCanonicalString()).toBe("0:2:3::/56");
        expect(slices.get(1n).toCanonicalString()).toBe("0:2:3:100::/56");
        expect(slices.get(255n).toCanonicalString()).toBe("0:2:3:ff00::/56");
    });
